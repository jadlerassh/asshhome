...
import sty from "./PlasmicPartnerEmail.module.css"; // plasmic-import: gxTQfdx_BnWL/css

createPlasmicElementProxy;

export const PlasmicPartnerEmail__VariantProps = new Array();

export const PlasmicPartnerEmail__ArgProps = new Array();
...
function PlasmicPartnerEmail__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicPartnerEmail.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPartnerEmail.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__guZrE)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Partner Email - Title Card"}
          />

          <div className={classNames(projectcss.all, sty.freeBox___7TtB)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__loLuO
              )}
              title={"Partner with ASSH - Email Advertising"}
            />
          </div>
          <div className={classNames(projectcss.all, sty.freeBox__ycWq)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox___9It5F)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__zxpXu)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__xZrCf)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__p8RFr
                  )}
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__mDgq)} />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPartnerEmail__ArgProps,
          internalVariantPropNames: PlasmicPartnerEmail__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPartnerEmail__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPartnerEmail";
  } else {
    func.displayName = `PlasmicPartnerEmail.${nodeName}`;
  }
  return func;
}

export const PlasmicPartnerEmail = Object.assign(
  // Top-level PlasmicPartnerEmail renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPartnerEmail
    internalVariantProps: PlasmicPartnerEmail__VariantProps,
    internalArgProps: PlasmicPartnerEmail__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Email Advertising | About | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicPartnerEmail;
/* prettier-ignore-end */
