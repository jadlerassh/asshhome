...
import sty from "./PlasmicComponentMenuFeaturedHighlight.module.css"; // plasmic-import: i3mM-1cWYoIK/css

createPlasmicElementProxy;

export const PlasmicComponentMenuFeaturedHighlight__VariantProps = new Array();

export const PlasmicComponentMenuFeaturedHighlight__ArgProps = new Array(
  "entryId"
);
...
function PlasmicComponentMenuFeaturedHighlight__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentMenuFeaturedHighlight__ArgProps,
          internalVariantPropNames:
            PlasmicComponentMenuFeaturedHighlight__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentMenuFeaturedHighlight__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentMenuFeaturedHighlight";
  } else {
    func.displayName = `PlasmicComponentMenuFeaturedHighlight.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentMenuFeaturedHighlight = Object.assign(
  // Top-level PlasmicComponentMenuFeaturedHighlight renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentMenuFeaturedHighlight
    internalVariantProps: PlasmicComponentMenuFeaturedHighlight__VariantProps,
    internalArgProps: PlasmicComponentMenuFeaturedHighlight__ArgProps
  }
);

export default PlasmicComponentMenuFeaturedHighlight;
/* prettier-ignore-end */
