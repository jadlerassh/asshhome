...
import sty from "./PlasmicInternational.module.css"; // plasmic-import: GArLdNDFwsSm/css

createPlasmicElementProxy;

export const PlasmicInternational__VariantProps = new Array();

export const PlasmicInternational__ArgProps = new Array();
...
function PlasmicInternational__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicInternational__ArgProps,
          internalVariantPropNames: PlasmicInternational__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicInternational__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicInternational";
  } else {
    func.displayName = `PlasmicInternational.${nodeName}`;
  }
  return func;
}

export const PlasmicInternational = Object.assign(
  // Top-level PlasmicInternational renders the root element
...
export default PlasmicInternational;
/* prettier-ignore-end */
