...
import sty from "./PlasmicItemEventCardItemOld.module.css"; // plasmic-import: 5J_xjozhBz7-/css

createPlasmicElementProxy;

export const PlasmicItemEventCardItemOld__VariantProps = new Array();

export const PlasmicItemEventCardItemOld__ArgProps = new Array(
  "imageId",
  "title",
  "location",
  "date",
...
function PlasmicItemEventCardItemOld__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicItemEventCardItemOld__ArgProps,
          internalVariantPropNames: PlasmicItemEventCardItemOld__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicItemEventCardItemOld__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicItemEventCardItemOld";
  } else {
    func.displayName = `PlasmicItemEventCardItemOld.${nodeName}`;
  }
  return func;
}

export const PlasmicItemEventCardItemOld = Object.assign(
  // Top-level PlasmicItemEventCardItemOld renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    section: makeNodeComponent("section"),
    img: makeNodeComponent("img"),
    // Metadata about props expected for PlasmicItemEventCardItemOld
    internalVariantProps: PlasmicItemEventCardItemOld__VariantProps,
    internalArgProps: PlasmicItemEventCardItemOld__ArgProps
  }
);

export default PlasmicItemEventCardItemOld;
/* prettier-ignore-end */
