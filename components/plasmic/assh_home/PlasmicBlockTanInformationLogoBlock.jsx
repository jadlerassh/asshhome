...
import sty from "./PlasmicBlockTanInformationLogoBlock.module.css"; // plasmic-import: KjbcRISpC18Z/css
...
export const PlasmicBlockTanInformationLogoBlock__VariantProps = new Array();

export const PlasmicBlockTanInformationLogoBlock__ArgProps = new Array(
  "title",
  "desc"
);
...
function PlasmicBlockTanInformationLogoBlock__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBlockTanInformationLogoBlock__ArgProps,
          internalVariantPropNames:
            PlasmicBlockTanInformationLogoBlock__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBlockTanInformationLogoBlock__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBlockTanInformationLogoBlock";
  } else {
    func.displayName = `PlasmicBlockTanInformationLogoBlock.${nodeName}`;
  }
  return func;
}

export const PlasmicBlockTanInformationLogoBlock = Object.assign(
  // Top-level PlasmicBlockTanInformationLogoBlock renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBlockTanInformationLogoBlock
    internalVariantProps: PlasmicBlockTanInformationLogoBlock__VariantProps,
    internalArgProps: PlasmicBlockTanInformationLogoBlock__ArgProps
  }
);

export default PlasmicBlockTanInformationLogoBlock;
/* prettier-ignore-end */
