...
import sty from "./PlasmicBlockHeroBannerBlockItemOld.module.css"; // plasmic-import: 4D_-oe1r0Jy9/css

createPlasmicElementProxy;

export const PlasmicBlockHeroBannerBlockItemOld__VariantProps = new Array(
  "first2",
  "last2"
);

export const PlasmicBlockHeroBannerBlockItemOld__ArgProps = new Array(
  "entryId",
  "highlightColor"
);
...
function PlasmicBlockHeroBannerBlockItemOld__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBlockHeroBannerBlockItemOld__ArgProps,
          internalVariantPropNames:
            PlasmicBlockHeroBannerBlockItemOld__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBlockHeroBannerBlockItemOld__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBlockHeroBannerBlockItemOld";
  } else {
    func.displayName = `PlasmicBlockHeroBannerBlockItemOld.${nodeName}`;
  }
  return func;
}

export const PlasmicBlockHeroBannerBlockItemOld = Object.assign(
  // Top-level PlasmicBlockHeroBannerBlockItemOld renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    embedHtml: makeNodeComponent("embedHtml"),
    // Metadata about props expected for PlasmicBlockHeroBannerBlockItemOld
    internalVariantProps: PlasmicBlockHeroBannerBlockItemOld__VariantProps,
    internalArgProps: PlasmicBlockHeroBannerBlockItemOld__ArgProps
  }
);

export default PlasmicBlockHeroBannerBlockItemOld;
/* prettier-ignore-end */
