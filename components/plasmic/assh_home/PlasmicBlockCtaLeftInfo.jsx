...
import sty from "./PlasmicBlockCtaLeftInfo.module.css"; // plasmic-import: PDBoM43wxd7a/css

createPlasmicElementProxy;

export const PlasmicBlockCtaLeftInfo__VariantProps = new Array();

export const PlasmicBlockCtaLeftInfo__ArgProps = new Array(
  "bgColor",
  "imageId"
);
...
function PlasmicBlockCtaLeftInfo__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBlockCtaLeftInfo__ArgProps,
          internalVariantPropNames: PlasmicBlockCtaLeftInfo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBlockCtaLeftInfo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBlockCtaLeftInfo";
  } else {
    func.displayName = `PlasmicBlockCtaLeftInfo.${nodeName}`;
  }
  return func;
}

export const PlasmicBlockCtaLeftInfo = Object.assign(
  // Top-level PlasmicBlockCtaLeftInfo renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBlockCtaLeftInfo
    internalVariantProps: PlasmicBlockCtaLeftInfo__VariantProps,
    internalArgProps: PlasmicBlockCtaLeftInfo__ArgProps
  }
);

export default PlasmicBlockCtaLeftInfo;
/* prettier-ignore-end */
