...
import sty from "./PlasmicAsshDropdownButtonHamburger.module.css"; // plasmic-import: qpQjKfyYOrul/css
import CloseBoldSvgrepoComSvgIcon from "./icons/PlasmicIcon__CloseBoldSvgrepoComSvg"; // plasmic-import: kgKw8A-hT9fj/icon

createPlasmicElementProxy;

export const PlasmicAsshDropdownButtonHamburger__VariantProps = new Array(
  "clickedOpen"
);

export const PlasmicAsshDropdownButtonHamburger__ArgProps = new Array();
...
function PlasmicAsshDropdownButtonHamburger__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicAsshDropdownButtonHamburger__ArgProps,
          internalVariantPropNames:
            PlasmicAsshDropdownButtonHamburger__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicAsshDropdownButtonHamburger__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicAsshDropdownButtonHamburger";
  } else {
    func.displayName = `PlasmicAsshDropdownButtonHamburger.${nodeName}`;
  }
  return func;
}

export const PlasmicAsshDropdownButtonHamburger = Object.assign(
  // Top-level PlasmicAsshDropdownButtonHamburger renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicAsshDropdownButtonHamburger
    internalVariantProps: PlasmicAsshDropdownButtonHamburger__VariantProps,
    internalArgProps: PlasmicAsshDropdownButtonHamburger__ArgProps
  }
);

export default PlasmicAsshDropdownButtonHamburger;
/* prettier-ignore-end */
