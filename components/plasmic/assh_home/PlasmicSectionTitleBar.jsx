...
import sty from "./PlasmicSectionTitleBar.module.css"; // plasmic-import: 8dary0IReKTd/css
...
function PlasmicSectionTitleBar__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSectionTitleBar__ArgProps,
          internalVariantPropNames: PlasmicSectionTitleBar__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSectionTitleBar__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSectionTitleBar";
  } else {
    func.displayName = `PlasmicSectionTitleBar.${nodeName}`;
  }
  return func;
}

export const PlasmicSectionTitleBar = Object.assign(
  // Top-level PlasmicSectionTitleBar renders the root element
  makeNodeComponent("root"),
  {
    ...
    internalArgProps: PlasmicSectionTitleBar__ArgProps
  }
);

export default PlasmicSectionTitleBar;
/* prettier-ignore-end */
