...
import sty from "./PlasmicComponentLinkOutItem.module.css"; // plasmic-import: rLtSCz5xy5NR/css
...
export const PlasmicComponentLinkOutItem__VariantProps = new Array();

export const PlasmicComponentLinkOutItem__ArgProps = new Array(
  "articleTitle",
  "articleSubtitle",
  "linkUrl",
  "showIcon",
...
function PlasmicComponentLinkOutItem__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentLinkOutItem__ArgProps,
          internalVariantPropNames: PlasmicComponentLinkOutItem__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentLinkOutItem__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentLinkOutItem";
  } else {
    func.displayName = `PlasmicComponentLinkOutItem.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentLinkOutItem = Object.assign(
  // Top-level PlasmicComponentLinkOutItem renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentLinkOutItem
    internalVariantProps: PlasmicComponentLinkOutItem__VariantProps,
    internalArgProps: PlasmicComponentLinkOutItem__ArgProps
  }
);

export default PlasmicComponentLinkOutItem;
/* prettier-ignore-end */
