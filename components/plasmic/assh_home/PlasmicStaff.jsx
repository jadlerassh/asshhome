...
import sty from "./PlasmicStaff.module.css"; // plasmic-import: -7trvxN5p1zg/css

createPlasmicElementProxy;

export const PlasmicStaff__VariantProps = new Array();

export const PlasmicStaff__ArgProps = new Array();
...
function PlasmicStaff__RenderFunc(props) {
  ...
  const new$Queries = {
    getPerson: usePlasmicDataOp(() => {
      return {
        ...
        opId: "c8b9b381-0266-4dd2-a2a2-3e616ec326a3",
        userArgs: {},
        cacheKey: `plasmic.$.c8b9b381-0266-4dd2-a2a2-3e616ec326a3.$.`,
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__blJ9P
            )}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicStaff__ArgProps,
          internalVariantPropNames: PlasmicStaff__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicStaff__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicStaff";
  } else {
    func.displayName = `PlasmicStaff.${nodeName}`;
  }
  return func;
}

export const PlasmicStaff = Object.assign(
  // Top-level PlasmicStaff renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicStaff
    internalVariantProps: PlasmicStaff__VariantProps,
    internalArgProps: PlasmicStaff__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "",
      description: "",
