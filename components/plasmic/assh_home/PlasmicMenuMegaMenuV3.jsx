...
import sty from "./PlasmicMenuMegaMenuV3.module.css"; // plasmic-import: JkFIcWlNPkDe/css
...
export const PlasmicMenuMegaMenuV3__VariantProps = new Array();

export const PlasmicMenuMegaMenuV3__ArgProps = new Array(
  "exploreOpen",
  "onExploreOpenChange",
  "cartQuantity",
  "accountName",
...
function PlasmicMenuMegaMenuV3__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicMenuMegaMenuV3__ArgProps,
          internalVariantPropNames: PlasmicMenuMegaMenuV3__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicMenuMegaMenuV3__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicMenuMegaMenuV3";
  } else {
    func.displayName = `PlasmicMenuMegaMenuV3.${nodeName}`;
  }
  return func;
}

export const PlasmicMenuMegaMenuV3 = Object.assign(
  // Top-level PlasmicMenuMegaMenuV3 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicMenuMegaMenuV3
    internalVariantProps: PlasmicMenuMegaMenuV3__VariantProps,
    internalArgProps: PlasmicMenuMegaMenuV3__ArgProps
  }
);

export default PlasmicMenuMegaMenuV3;
/* prettier-ignore-end */
