...
import sty from "./PlasmicHfdaDirectorResources.module.css"; // plasmic-import: 5ycDgpbcuZpH/css

createPlasmicElementProxy;

export const PlasmicHfdaDirectorResources__VariantProps = new Array();

export const PlasmicHfdaDirectorResources__ArgProps = new Array();
...
function PlasmicHfdaDirectorResources__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicHfdaDirectorResources.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicHfdaDirectorResources.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__geXcy
            )}
          />
          ...
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: HFDA Program Director Resources - Title Card"}
          />
          ...
          >
            <HtmlContentfulHtmlLoader
              ...
              title={"HFDA Program Director Resources"}
            />
          </div>
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__kcGkG
            )}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHfdaDirectorResources__ArgProps,
          internalVariantPropNames: PlasmicHfdaDirectorResources__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHfdaDirectorResources__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHfdaDirectorResources";
  } else {
    func.displayName = `PlasmicHfdaDirectorResources.${nodeName}`;
  }
  return func;
}

export const PlasmicHfdaDirectorResources = Object.assign(
  // Top-level PlasmicHfdaDirectorResources renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHfdaDirectorResources
    internalVariantProps: PlasmicHfdaDirectorResources__VariantProps,
    internalArgProps: PlasmicHfdaDirectorResources__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "HFDA Director Resources | Education | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicHfdaDirectorResources;
/* prettier-ignore-end */
