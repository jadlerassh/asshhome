...
import sty from "./PlasmicTemplateInternalPageWithAccordion2.module.css"; // plasmic-import: kNMksSTb_cmV/css

createPlasmicElementProxy;

export const PlasmicTemplateInternalPageWithAccordion2__VariantProps =
  new Array();

export const PlasmicTemplateInternalPageWithAccordion2__ArgProps = new Array();
...
function PlasmicTemplateInternalPageWithAccordion2__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicTemplateInternalPageWithAccordion2.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicTemplateInternalPageWithAccordion2.pageMetadata.title}
        />
        ...
        <meta
          ...
          name="description"
          content={
            PlasmicTemplateInternalPageWithAccordion2.pageMetadata.description
          }
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__vOmna)} />
          ...
          <div className={classNames(projectcss.all, sty.freeBox___6Srch)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__dhycq
              )}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__wqnRh)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__kvKhw)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__bTeBx)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__m8VrH
                  )}
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__nwpcc)} />
...
function makeNodeComponent(nodeName) {
      ...
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames:
            PlasmicTemplateInternalPageWithAccordion2__ArgProps,
          internalVariantPropNames:
            PlasmicTemplateInternalPageWithAccordion2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTemplateInternalPageWithAccordion2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTemplateInternalPageWithAccordion2";
  } else {
    func.displayName = `PlasmicTemplateInternalPageWithAccordion2.${nodeName}`;
  }
  return func;
}

export const PlasmicTemplateInternalPageWithAccordion2 = Object.assign(
  // Top-level PlasmicTemplateInternalPageWithAccordion2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTemplateInternalPageWithAccordion2
    internalVariantProps:
      PlasmicTemplateInternalPageWithAccordion2__VariantProps,
    internalArgProps: PlasmicTemplateInternalPageWithAccordion2__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "TEMPLATE - Internal Page with Accordion",
      description:
...
export default PlasmicTemplateInternalPageWithAccordion2;
/* prettier-ignore-end */
