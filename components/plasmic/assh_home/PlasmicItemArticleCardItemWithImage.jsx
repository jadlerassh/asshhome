...
import sty from "./PlasmicItemArticleCardItemWithImage.module.css"; // plasmic-import: rJ18UjQomkxN/css

createPlasmicElementProxy;

export const PlasmicItemArticleCardItemWithImage__VariantProps = new Array();

export const PlasmicItemArticleCardItemWithImage__ArgProps = new Array(
  "heading",
  "articleTitle",
  "description2",
  "linkUrl",
...
function PlasmicItemArticleCardItemWithImage__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicItemArticleCardItemWithImage__ArgProps,
          internalVariantPropNames:
            PlasmicItemArticleCardItemWithImage__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicItemArticleCardItemWithImage__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicItemArticleCardItemWithImage";
  } else {
    func.displayName = `PlasmicItemArticleCardItemWithImage.${nodeName}`;
  }
  return func;
}

export const PlasmicItemArticleCardItemWithImage = Object.assign(
  // Top-level PlasmicItemArticleCardItemWithImage renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicItemArticleCardItemWithImage
    internalVariantProps: PlasmicItemArticleCardItemWithImage__VariantProps,
    internalArgProps: PlasmicItemArticleCardItemWithImage__ArgProps
  }
);

export default PlasmicItemArticleCardItemWithImage;
/* prettier-ignore-end */
