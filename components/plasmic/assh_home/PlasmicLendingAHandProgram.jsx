...
import sty from "./PlasmicLendingAHandProgram.module.css"; // plasmic-import: WLZQOyitmwZ0/css

createPlasmicElementProxy;

export const PlasmicLendingAHandProgram__VariantProps = new Array();

export const PlasmicLendingAHandProgram__ArgProps = new Array();
...
function PlasmicLendingAHandProgram__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicLendingAHandProgram.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicLendingAHandProgram.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__nE3Al)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Lending a Hand Program - Title Card"}
          />

          <div className={classNames(projectcss.all, sty.freeBox__hMsKe)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__tcpib)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox___3Imjt)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__zrOrb)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__zCgGa)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__hiuGc
                  )}
          ...
          <ItemAd
            className={classNames("__wab_instance", sty.itemAd___9L9Xe)}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicLendingAHandProgram__ArgProps,
          internalVariantPropNames: PlasmicLendingAHandProgram__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicLendingAHandProgram__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicLendingAHandProgram";
  } else {
    func.displayName = `PlasmicLendingAHandProgram.${nodeName}`;
  }
  return func;
}

export const PlasmicLendingAHandProgram = Object.assign(
  // Top-level PlasmicLendingAHandProgram renders the root element
...
export default PlasmicLendingAHandProgram;
/* prettier-ignore-end */
