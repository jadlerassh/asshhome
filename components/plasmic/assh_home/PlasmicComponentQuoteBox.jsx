...
import sty from "./PlasmicComponentQuoteBox.module.css"; // plasmic-import: pkNfPBeJPFGR/css
import Container2Icon from "./icons/PlasmicIcon__Container2"; // plasmic-import: TKWn1DDMMFQp/icon

createPlasmicElementProxy;

export const PlasmicComponentQuoteBox__VariantProps = new Array();

export const PlasmicComponentQuoteBox__ArgProps = new Array(
  "quoteText",
  "drName",
  "title",
  "tagline"
...
function PlasmicComponentQuoteBox__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentQuoteBox__ArgProps,
          internalVariantPropNames: PlasmicComponentQuoteBox__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentQuoteBox__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentQuoteBox";
  } else {
    func.displayName = `PlasmicComponentQuoteBox.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentQuoteBox = Object.assign(
  // Top-level PlasmicComponentQuoteBox renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentQuoteBox
    internalVariantProps: PlasmicComponentQuoteBox__VariantProps,
    internalArgProps: PlasmicComponentQuoteBox__ArgProps
  }
);

export default PlasmicComponentQuoteBox;
/* prettier-ignore-end */
