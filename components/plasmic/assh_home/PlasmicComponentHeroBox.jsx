...
import sty from "./PlasmicComponentHeroBox.module.css"; // plasmic-import: uP-uUACbvTsG/css
import RightChevronSvgIcon from "./icons/PlasmicIcon__RightChevronSvg"; // plasmic-import: CVi8xEyvKenj/icon

createPlasmicElementProxy;

export const PlasmicComponentHeroBox__VariantProps = new Array(
  "_1",
  "_2",
  "_3",
  "_4"
...
export const PlasmicComponentHeroBox__ArgProps = new Array();
...
function PlasmicComponentHeroBox__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentHeroBox__ArgProps,
          internalVariantPropNames: PlasmicComponentHeroBox__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentHeroBox__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentHeroBox";
  } else {
    func.displayName = `PlasmicComponentHeroBox.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentHeroBox = Object.assign(
  // Top-level PlasmicComponentHeroBox renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentHeroBox
    internalVariantProps: PlasmicComponentHeroBox__VariantProps,
    internalArgProps: PlasmicComponentHeroBox__ArgProps
  }
);

export default PlasmicComponentHeroBox;
/* prettier-ignore-end */
