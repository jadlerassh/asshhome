...
import AsshMegaMenuSubItem from "../../AsshMegaMenuSubItem"; // plasmic-import: JNcUMWnpd-Gl/component
import DropdownCurrentUser from "../../DropdownCurrentUser"; // plasmic-import: zbpbv6MhDowI/component
import AsshMegaMenuItem from "../../AsshMegaMenuItem"; // plasmic-import: PuojKIT8N0Q4/component
import ComponentLinkOutItem from "../../ComponentLinkOutItem"; // plasmic-import: rLtSCz5xy5NR/component
import ComponentMenuFeaturedHighlight from "../../ComponentMenuFeaturedHighlight"; // plasmic-import: i3mM-1cWYoIK/component
...
import sty from "./PlasmicSectionAsshHomeMenu.module.css"; // plasmic-import: HrBwnQh3XfKO/css
...
export const PlasmicSectionAsshHomeMenu__VariantProps = new Array(
  "dropdown1",
  "dropdown2",
  "dropdown3",
  "dropdown4",
...
export const PlasmicSectionAsshHomeMenu__ArgProps = new Array(
  "userName",
  "member",
  "asshId",
  "memberType",
...
function PlasmicSectionAsshHomeMenu__RenderFunc(props) {
  ...
  const new$Queries = {
    getMegaMenuOne: usePlasmicDataOp(() => {
      return {
        ...
        opId: "75ace091-92c3-4af3-8e3c-4785d5af6062",
        userArgs: {},
        cacheKey: `plasmic.$.75ace091-92c3-4af3-8e3c-4785d5af6062.$.`,
      ...
      >
                    ...
                    return (
                      ...
                      >
                        <AsshMegaMenuSubItem
                          className={classNames(
                            "__wab_instance",
                            sty.asshMegaMenuSubItem__odi0H
                          )}
                          label={(() => {
                            try {
        ...
        >
          ...
          >
            ...
            >
              <DropdownCurrentUser
                data-plasmic-name={"dropdownCurrentUser"}
                data-plasmic-override={overrides.dropdownCurrentUser}
                className={classNames(
                  "__wab_instance",
                  sty.dropdownCurrentUser
                )}
                userImageUrl={(() => {
                  try {
              ...
              return (
                <Stack__
                  ...
                  onClick={async event => {
                    ...
                    $steps["toggleDropdown1"] = true
                      ...
                      : undefined;
                    if (
                      $steps["toggleDropdown1"] != null &&
                      typeof $steps["toggleDropdown1"] === "object" &&
                      typeof $steps["toggleDropdown1"].then === "function"
                    ) {
                      $steps["toggleDropdown1"] = await $steps[
                        "toggleDropdown1"
                      ];
                    }
                    ...
                    $steps["updateDropdown4"] = true
                      ...
                      : undefined;
                    if (
                      $steps["updateDropdown4"] != null &&
                      typeof $steps["updateDropdown4"] === "object" &&
                      typeof $steps["updateDropdown4"].then === "function"
                    ) {
                      $steps["updateDropdown4"] = await $steps[
                        "updateDropdown4"
                      ];
                    }
                    $steps["updateDropdown5"] = true
                      ? (() => {
                          const actionArgs = {
                            vgroup: "dropdown5",
                            operation: 6
                      ...
                      : undefined;
                    if (
                      $steps["updateDropdown5"] != null &&
                      typeof $steps["updateDropdown5"] === "object" &&
                      typeof $steps["updateDropdown5"].then === "function"
                    ) {
                      $steps["updateDropdown5"] = await $steps[
                        "updateDropdown5"
                      ];
                    }
                    $steps["updateDropdown6"] = true
                      ? (() => {
                          const actionArgs = {
                            vgroup: "dropdown6",
                            operation: 6
                      ...
                      : undefined;
                    if (
                      $steps["updateDropdown6"] != null &&
                      typeof $steps["updateDropdown6"] === "object" &&
                      typeof $steps["updateDropdown6"].then === "function"
                    ) {
                      $steps["updateDropdown6"] = await $steps[
                        "updateDropdown6"
                      ];
                    }
                    $steps["updateDropdown7"] = true
                      ? (() => {
                          const actionArgs = {
                            vgroup: "dropdown7",
                            operation: 6
                      ...
                      : undefined;
                    if (
                      $steps["updateDropdown7"] != null &&
                      typeof $steps["updateDropdown7"] === "object" &&
                      typeof $steps["updateDropdown7"].then === "function"
                    ) {
                      $steps["updateDropdown7"] = await $steps[
                        "updateDropdown7"
                      ];
                    }
                  }}
                >
                  <AsshMegaMenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.asshMegaMenuItem__uyOst,
                      {
                        [sty.asshMegaMenuItemdropdown1__uyOstwLNaE]: hasVariant(
                          $state,
                          "dropdown1",
                          "dropdown1"
                        )
                        ...
                        return (
                          ...
                          >
                            <AsshMegaMenuSubItem
                              className={classNames(
                                "__wab_instance",
                                sty.asshMegaMenuSubItem__jvqzb
                              )}
                              label={(() => {
                                try {
                                  return currentItem.label;
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__xfmrq,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__xfmrqwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__xfmrqrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2")
                        }
                      )}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__c7K3G,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__c7K3GwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__c7K3GrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2")
                        }
                      )}
                      label={`${currentItem.label} `}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem___8Sftf,
                        {
                          [sty.asshMegaMenuSubItemdropdown1___8SftfwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2___8SftfrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.asshMegaMenuSubItemdropdown3___8SftfC1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.asshMegaMenuSubItemdropdown4___8SftfAjXtF]:
                            hasVariant($state, "dropdown4", "dropdown4")
                        }
                      )}
                      label={`${currentItem.label} `}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__zmBaW,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__zmBaWwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__zmBaWrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.asshMegaMenuSubItemdropdown3__zmBaWc1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.asshMegaMenuSubItemdropdown4__zmBaWajXtF]:
                            hasVariant($state, "dropdown4", "dropdown4"),
                          [sty.asshMegaMenuSubItemdropdown5__zmBaWllPSu]:
                            hasVariant($state, "dropdown5", "dropdown5"),
                          [sty.asshMegaMenuSubItemdropdown7__zmBaW6Z5G8]:
                            hasVariant($state, "dropdown7", "dropdown7")
                        }
                      )}
                      label={`${currentItem.label} `}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__l31P2,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__l31P2WLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__l31P2RwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.asshMegaMenuSubItemdropdown3__l31P2C1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.asshMegaMenuSubItemdropdown4__l31P2AjXtF]:
                            hasVariant($state, "dropdown4", "dropdown4"),
                          [sty.asshMegaMenuSubItemdropdown5__l31P2LlPSu]:
                            hasVariant($state, "dropdown5", "dropdown5")
                        }
                      )}
                      label={`${currentItem.label} `}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__meEzp,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__meEzpwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__meEzprwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.asshMegaMenuSubItemdropdown3__meEzpC1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.asshMegaMenuSubItemdropdown4__meEzpAjXtF]:
                            hasVariant($state, "dropdown4", "dropdown4"),
                          [sty.asshMegaMenuSubItemdropdown5__meEzpllPSu]:
                            hasVariant($state, "dropdown5", "dropdown5"),
                          [sty.asshMegaMenuSubItemdropdown6__meEzpwq0Uc]:
                            hasVariant($state, "dropdown6", "dropdown6")
                        }
                      )}
                      label={`${currentItem.label} `}
                ...
                return (
                  ...
                  >
                    <AsshMegaMenuSubItem
                      className={classNames(
                        "__wab_instance",
                        sty.asshMegaMenuSubItem__gn6XZ,
                        {
                          [sty.asshMegaMenuSubItemdropdown1__gn6XZwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.asshMegaMenuSubItemdropdown2__gn6XZrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.asshMegaMenuSubItemdropdown3__gn6XZc1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.asshMegaMenuSubItemdropdown4__gn6XZajXtF]:
                            hasVariant($state, "dropdown4", "dropdown4"),
                          [sty.asshMegaMenuSubItemdropdown5__gn6XZllPSu]:
                            hasVariant($state, "dropdown5", "dropdown5"),
                          [sty.asshMegaMenuSubItemdropdown6__gn6XZwq0Uc]:
                            hasVariant($state, "dropdown6", "dropdown6")
                        }
                      )}
                      label={`${currentItem.label} `}
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__tuim4,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__tuim4WLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1"),
                            [sty.asshMegaMenuSubItemdropdown2__tuim4RwAmm]:
                              hasVariant($state, "dropdown2", "dropdown2")
                          }
                        )}
                        label={(() => {
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__dxRv,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__dxRvWLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1")
                          }
                        )}
                        label={(() => {
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__o9BD,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__o9BDwLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1"),
                            [sty.asshMegaMenuSubItemdropdown2__o9BDrwAmm]:
                              hasVariant($state, "dropdown2", "dropdown2"),
                            [sty.asshMegaMenuSubItemdropdown4__o9BDAjXtF]:
                              hasVariant($state, "dropdown4", "dropdown4"),
                            [sty.asshMegaMenuSubItemdropdown5__o9BDllPSu]:
                              hasVariant($state, "dropdown5", "dropdown5")
                          }
                        )}
                        label={(() => {
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__gM8Pw,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__gM8PWwLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1"),
                            [sty.asshMegaMenuSubItemdropdown2__gM8PWrwAmm]:
                              hasVariant($state, "dropdown2", "dropdown2"),
                            [sty.asshMegaMenuSubItemdropdown3__gM8Pwc1Ig]:
                              hasVariant($state, "dropdown3", "dropdown3"),
                            [sty.asshMegaMenuSubItemdropdown4__gM8PwajXtF]:
                              hasVariant($state, "dropdown4", "dropdown4"),
                            [sty.asshMegaMenuSubItemdropdown7__gM8Pw6Z5G8]:
                              hasVariant($state, "dropdown7", "dropdown7")
                          }
                        )}
                        label={(() => {
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__qz82F,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__qz82FwLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1"),
                            [sty.asshMegaMenuSubItemdropdown2__qz82FrwAmm]:
                              hasVariant($state, "dropdown2", "dropdown2"),
                            [sty.asshMegaMenuSubItemdropdown4__qz82FAjXtF]:
                              hasVariant($state, "dropdown4", "dropdown4"),
                            [sty.asshMegaMenuSubItemdropdown6__qz82Fwq0Uc]:
                              hasVariant($state, "dropdown6", "dropdown6")
                          }
                        )}
                        label={(() => {
                  ...
                  return (
                    ...
                    >
                      <AsshMegaMenuSubItem
                        className={classNames(
                          "__wab_instance",
                          sty.asshMegaMenuSubItem__wjk9Y,
                          {
                            [sty.asshMegaMenuSubItemdropdown1__wjk9YwLNaE]:
                              hasVariant($state, "dropdown1", "dropdown1"),
                            [sty.asshMegaMenuSubItemdropdown2__wjk9YrwAmm]:
                              hasVariant($state, "dropdown2", "dropdown2"),
                            [sty.asshMegaMenuSubItemdropdown4__wjk9YajXtF]:
                              hasVariant($state, "dropdown4", "dropdown4"),
                            [sty.asshMegaMenuSubItemdropdown5__wjk9YllPSu]:
                              hasVariant($state, "dropdown5", "dropdown5"),
                            [sty.asshMegaMenuSubItemdropdown6__wjk9Ywq0Uc]:
                              hasVariant($state, "dropdown6", "dropdown6")
                          }
                        )}
                        label={(() => {
                      ...
                      return (
                        ...
                        >
                          <AsshMegaMenuSubItem
                            className={classNames(
                              "__wab_instance",
                              sty.asshMegaMenuSubItem___38OdQ,
                              {
                                [sty.asshMegaMenuSubItemdropdown1___38OdQwLNaE]:
                                  hasVariant($state, "dropdown1", "dropdown1"),
                                [sty.asshMegaMenuSubItemdropdown2___38OdQrwAmm]:
                                  hasVariant($state, "dropdown2", "dropdown2"),
                                [sty.asshMegaMenuSubItemdropdown4___38OdQajXtF]:
                                  hasVariant($state, "dropdown4", "dropdown4"),
                                [sty.asshMegaMenuSubItemdropdown6___38OdQwq0Uc]:
                                  hasVariant($state, "dropdown6", "dropdown6")
                              }
                            )}
                            label={(() => {
                ...
                return (
                  ...
                  >
                    <ComponentLinkOutItem
                      ...
                      className={classNames(
                        "__wab_instance",
                        sty.componentLinkOutItem__oLsHk,
                        {
                          [sty.componentLinkOutItemdropdown1__oLsHKwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.componentLinkOutItemdropdown2__oLsHKrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2"),
                          [sty.componentLinkOutItemdropdown3__oLsHkc1Ig]:
                            hasVariant($state, "dropdown3", "dropdown3"),
                          [sty.componentLinkOutItemdropdown4__oLsHkajXtF]:
                            hasVariant($state, "dropdown4", "dropdown4"),
                          [sty.componentLinkOutItemdropdown5__oLsHKllPSu]:
                            hasVariant($state, "dropdown5", "dropdown5"),
                          [sty.componentLinkOutItemdropdown6__oLsHKwq0Uc]:
                            hasVariant($state, "dropdown6", "dropdown6"),
                          [sty.componentLinkOutItemdropdown7__oLsHk6Z5G8]:
                            hasVariant($state, "dropdown7", "dropdown7"),
                          [sty.componentLinkOutItemexploreAssh__oLsHKpX9Ih]:
                            hasVariant($state, "exploreAssh", "exploreAssh")
                        }
                      )}
                      iconImageId={
                ...
                return (
                  ...
                  >
                    <ComponentLinkOutItem
                      ...
                      className={classNames(
                        "__wab_instance",
                        sty.componentLinkOutItem__kkPap,
                        {
                          [sty.componentLinkOutItemdropdown1__kkPapwLNaE]:
                            hasVariant($state, "dropdown1", "dropdown1"),
                          [sty.componentLinkOutItemdropdown2__kkPaprwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2")
                        }
                      )}
                      iconImageId={
            ...
            ? (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                ...
                return (
                  <Stack__
                    ...
                    key={currentIndex}
                  >
                    <ComponentMenuFeaturedHighlight
                      className={classNames(
                        "__wab_instance",
                        sty.componentMenuFeaturedHighlight__yfKgb,
                        {
                          [sty.componentMenuFeaturedHighlightdropdown2__yfKgbrwAmm]:
                            hasVariant($state, "dropdown2", "dropdown2")
                        }
                      )}
                      entryId={(() => {
            ...
            return (
              ...
              >
                <ComponentMenuFeaturedHighlight
                  className={classNames(
                    "__wab_instance",
                    sty.componentMenuFeaturedHighlight__ndHk0,
                    {
                      [sty.componentMenuFeaturedHighlightdropdown1__ndHk0WLNaE]:
                        hasVariant($state, "dropdown1", "dropdown1"),
                      [sty.componentMenuFeaturedHighlightdropdown2__ndHk0RwAmm]:
                        hasVariant($state, "dropdown2", "dropdown2"),
                      [sty.componentMenuFeaturedHighlightdropdown5__ndHk0LlPSu]:
                        hasVariant($state, "dropdown5", "dropdown5"),
                      [sty.componentMenuFeaturedHighlightdropdown6__ndHk0Wq0Uc]:
                        hasVariant($state, "dropdown6", "dropdown6"),
                      [sty.componentMenuFeaturedHighlightdropdown7__ndHk06Z5G8]:
                        hasVariant($state, "dropdown7", "dropdown7")
                    }
                  )}
                  entryId={(() => {
...
const PlasmicDescendants = {
  ...
  frame8: ["frame8", "dropdownCurrentUser", "iconButton", "icon24X24"],
  dropdownCurrentUser: ["dropdownCurrentUser"],
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSectionAsshHomeMenu__ArgProps,
          internalVariantPropNames: PlasmicSectionAsshHomeMenu__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSectionAsshHomeMenu__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSectionAsshHomeMenu";
  } else {
    func.displayName = `PlasmicSectionAsshHomeMenu.${nodeName}`;
  }
  return func;
}

export const PlasmicSectionAsshHomeMenu = Object.assign(
  // Top-level PlasmicSectionAsshHomeMenu renders the root element
  makeNodeComponent("root"),
  {
    ...
    dropdownCurrentUser: makeNodeComponent("dropdownCurrentUser"),
    ...
    // Metadata about props expected for PlasmicSectionAsshHomeMenu
    internalVariantProps: PlasmicSectionAsshHomeMenu__VariantProps,
    internalArgProps: PlasmicSectionAsshHomeMenu__ArgProps
  }
);

export default PlasmicSectionAsshHomeMenu;
/* prettier-ignore-end */
