...
import sty from "./PlasmicPartnerScholarshipProgram.module.css"; // plasmic-import: sWSGh8WlgtIr/css

createPlasmicElementProxy;

export const PlasmicPartnerScholarshipProgram__VariantProps = new Array();

export const PlasmicPartnerScholarshipProgram__ArgProps = new Array();
...
function PlasmicPartnerScholarshipProgram__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicPartnerScholarshipProgram.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPartnerScholarshipProgram.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__xef4Z)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Partner Scholarship Program - Title Card"}
          />

          <div className={classNames(projectcss.all, sty.freeBox__mgKsB)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__xjCt
              )}
              title={"Partner with ASSH - Scholarship Program"}
            />
          </div>
          <div className={classNames(projectcss.all, sty.freeBox__wpv3O)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__clXfV)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column___9KcE)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column___10Dk)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader___06UW
                  )}
          ...
          <ItemAd
            className={classNames("__wab_instance", sty.itemAd___5GXax)}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPartnerScholarshipProgram__ArgProps,
          internalVariantPropNames:
            PlasmicPartnerScholarshipProgram__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPartnerScholarshipProgram__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPartnerScholarshipProgram";
  } else {
    func.displayName = `PlasmicPartnerScholarshipProgram.${nodeName}`;
  }
  return func;
}

export const PlasmicPartnerScholarshipProgram = Object.assign(
  // Top-level PlasmicPartnerScholarshipProgram renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPartnerScholarshipProgram
    internalVariantProps: PlasmicPartnerScholarshipProgram__VariantProps,
    internalArgProps: PlasmicPartnerScholarshipProgram__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Annual Meeting Scholarship Program | About | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicPartnerScholarshipProgram;
/* prettier-ignore-end */
