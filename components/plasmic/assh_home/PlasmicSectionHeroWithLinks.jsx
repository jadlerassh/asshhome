...
import sty from "./PlasmicSectionHeroWithLinks.module.css"; // plasmic-import: KrK4IjZZwAsd/css
...
export const PlasmicSectionHeroWithLinks__VariantProps = new Array();

export const PlasmicSectionHeroWithLinks__ArgProps = new Array();
...
function PlasmicSectionHeroWithLinks__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSectionHeroWithLinks__ArgProps,
          internalVariantPropNames: PlasmicSectionHeroWithLinks__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSectionHeroWithLinks__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSectionHeroWithLinks";
  } else {
    func.displayName = `PlasmicSectionHeroWithLinks.${nodeName}`;
  }
  return func;
}

export const PlasmicSectionHeroWithLinks = Object.assign(
  // Top-level PlasmicSectionHeroWithLinks renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSectionHeroWithLinks
    internalVariantProps: PlasmicSectionHeroWithLinks__VariantProps,
    internalArgProps: PlasmicSectionHeroWithLinks__ArgProps
  }
);

export default PlasmicSectionHeroWithLinks;
/* prettier-ignore-end */
