  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__vDhY6)} />
          ...
          <ItemSectionTitleDescriptionItem
            className={classNames(
              "__wab_instance",
              sty.itemSectionTitleDescriptionItem___2RhoH
            )}
            descriptionSection={``}
            title={``}
          />
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__aOv4)}
          >
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__nhtp)}
          >
            <ItemSectionTitleDescriptionItem
              className={classNames(
                "__wab_instance",
                sty.itemSectionTitleDescriptionItem__i1H2S
              )}
              descriptionSection={``}
            ...
            >
              <div className={classNames(projectcss.all, sty.column__vjjC)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__rVut)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__kIsmx
                  )}
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__q57FF)} />
