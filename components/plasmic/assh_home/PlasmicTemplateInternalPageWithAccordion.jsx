...
import sty from "./PlasmicTemplateInternalPageWithAccordion.module.css"; // plasmic-import: kNMksSTb_cmV/css

createPlasmicElementProxy;

export const PlasmicTemplateInternalPageWithAccordion__VariantProps =
  new Array();

export const PlasmicTemplateInternalPageWithAccordion__ArgProps = new Array();
...
function PlasmicTemplateInternalPageWithAccordion__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicTemplateInternalPageWithAccordion.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicTemplateInternalPageWithAccordion.pageMetadata.title}
        />
        ...
        <meta
          ...
          name="description"
          content={
            PlasmicTemplateInternalPageWithAccordion.pageMetadata.description
          }
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__y2Pzd
            )}
          />
          ...
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__caw8O
            )}
          />
...
function makeNodeComponent(nodeName) {
      ...
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames:
            PlasmicTemplateInternalPageWithAccordion__ArgProps,
          internalVariantPropNames:
            PlasmicTemplateInternalPageWithAccordion__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTemplateInternalPageWithAccordion__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTemplateInternalPageWithAccordion";
  } else {
    func.displayName = `PlasmicTemplateInternalPageWithAccordion.${nodeName}`;
  }
  return func;
}

export const PlasmicTemplateInternalPageWithAccordion = Object.assign(
  // Top-level PlasmicTemplateInternalPageWithAccordion renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTemplateInternalPageWithAccordion
    internalVariantProps:
      PlasmicTemplateInternalPageWithAccordion__VariantProps,
    internalArgProps: PlasmicTemplateInternalPageWithAccordion__ArgProps,
    // Page metadata
    pageMetadata: {
...
export default PlasmicTemplateInternalPageWithAccordion;
/* prettier-ignore-end */
