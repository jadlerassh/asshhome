...
import sty from "./PlasmicCtaRightInfo.module.css"; // plasmic-import: ODQZZ0K2m6aT/css

createPlasmicElementProxy;

export const PlasmicCtaRightInfo__VariantProps = new Array();

export const PlasmicCtaRightInfo__ArgProps = new Array("bgColor", "imageId");
...
function PlasmicCtaRightInfo__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCtaRightInfo__ArgProps,
          internalVariantPropNames: PlasmicCtaRightInfo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCtaRightInfo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCtaRightInfo";
  } else {
    func.displayName = `PlasmicCtaRightInfo.${nodeName}`;
  }
  return func;
}

export const PlasmicCtaRightInfo = Object.assign(
  // Top-level PlasmicCtaRightInfo renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCtaRightInfo
    internalVariantProps: PlasmicCtaRightInfo__VariantProps,
    internalArgProps: PlasmicCtaRightInfo__ArgProps
  }
);

export default PlasmicCtaRightInfo;
/* prettier-ignore-end */
