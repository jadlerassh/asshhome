...
import sty from "./PlasmicCodeOfEthics.module.css"; // plasmic-import: KgS5Dbg0QHlP/css

createPlasmicElementProxy;

export const PlasmicCodeOfEthics__VariantProps = new Array();

export const PlasmicCodeOfEthics__ArgProps = new Array();
...
function PlasmicCodeOfEthics__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCodeOfEthics.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCodeOfEthics.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__uwy4Z
            )}
          />
          ...
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Code of Ethics - Title Card"}
          />
          ...
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__gei3T
            )}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCodeOfEthics__ArgProps,
          internalVariantPropNames: PlasmicCodeOfEthics__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCodeOfEthics__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCodeOfEthics";
  } else {
    func.displayName = `PlasmicCodeOfEthics.${nodeName}`;
  }
  return func;
}

export const PlasmicCodeOfEthics = Object.assign(
  // Top-level PlasmicCodeOfEthics renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCodeOfEthics
    internalVariantProps: PlasmicCodeOfEthics__VariantProps,
    internalArgProps: PlasmicCodeOfEthics__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Code of Ethics | About Us | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicCodeOfEthics;
/* prettier-ignore-end */
