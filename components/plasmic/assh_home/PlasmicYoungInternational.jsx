...
import sty from "./PlasmicYoungInternational.module.css"; // plasmic-import: aPhMMkbvb3aC/css

createPlasmicElementProxy;

export const PlasmicYoungInternational__VariantProps = new Array();

export const PlasmicYoungInternational__ArgProps = new Array();
...
function PlasmicYoungInternational__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicYoungInternational__ArgProps,
          internalVariantPropNames: PlasmicYoungInternational__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicYoungInternational__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicYoungInternational";
  } else {
    func.displayName = `PlasmicYoungInternational.${nodeName}`;
  }
  return func;
}

export const PlasmicYoungInternational = Object.assign(
  // Top-level PlasmicYoungInternational renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicYoungInternational
    internalVariantProps: PlasmicYoungInternational__VariantProps,
    internalArgProps: PlasmicYoungInternational__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "",
      description: "",
...
export default PlasmicYoungInternational;
/* prettier-ignore-end */
