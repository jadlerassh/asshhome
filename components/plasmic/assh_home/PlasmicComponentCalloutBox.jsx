...
import sty from "./PlasmicComponentCalloutBox.module.css"; // plasmic-import: vxgZAhiQ4GBx/css
import Container2Icon from "./icons/PlasmicIcon__Container2"; // plasmic-import: TKWn1DDMMFQp/icon

createPlasmicElementProxy;

export const PlasmicComponentCalloutBox__VariantProps = new Array();

export const PlasmicComponentCalloutBox__ArgProps = new Array(
  "heading",
  "description3",
  "action",
  "actionUrl"
...
function PlasmicComponentCalloutBox__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentCalloutBox__ArgProps,
          internalVariantPropNames: PlasmicComponentCalloutBox__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentCalloutBox__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentCalloutBox";
  } else {
    func.displayName = `PlasmicComponentCalloutBox.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentCalloutBox = Object.assign(
  // Top-level PlasmicComponentCalloutBox renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentCalloutBox
    internalVariantProps: PlasmicComponentCalloutBox__VariantProps,
    internalArgProps: PlasmicComponentCalloutBox__ArgProps
  }
);

export default PlasmicComponentCalloutBox;
/* prettier-ignore-end */
