...
import sty from "./PlasmicComponentMembershipQuicklinks.module.css"; // plasmic-import: O2TSODJiol19/css

createPlasmicElementProxy;

export const PlasmicComponentMembershipQuicklinks__VariantProps = new Array();

export const PlasmicComponentMembershipQuicklinks__ArgProps = new Array();
