...
import sty from "./PlasmicCmeMissionStatementDisclaimer.module.css"; // plasmic-import: o8glZRYjkmDE/css

createPlasmicElementProxy;

export const PlasmicCmeMissionStatementDisclaimer__VariantProps = new Array();

export const PlasmicCmeMissionStatementDisclaimer__ArgProps = new Array();
...
function PlasmicCmeMissionStatementDisclaimer__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicCmeMissionStatementDisclaimer.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCmeMissionStatementDisclaimer.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: CME Mission and Disclaimer - Title Card"}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCmeMissionStatementDisclaimer__ArgProps,
          internalVariantPropNames:
            PlasmicCmeMissionStatementDisclaimer__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCmeMissionStatementDisclaimer__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCmeMissionStatementDisclaimer";
  } else {
    func.displayName = `PlasmicCmeMissionStatementDisclaimer.${nodeName}`;
  }
  return func;
}

export const PlasmicCmeMissionStatementDisclaimer = Object.assign(
  // Top-level PlasmicCmeMissionStatementDisclaimer renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCmeMissionStatementDisclaimer
    internalVariantProps: PlasmicCmeMissionStatementDisclaimer__VariantProps,
    internalArgProps: PlasmicCmeMissionStatementDisclaimer__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "CME Mission Statement & Disclaimer | Education | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicCmeMissionStatementDisclaimer;
/* prettier-ignore-end */
