...
import sty from "./PlasmicPartnerWithAssh.module.css"; // plasmic-import: Xo7uEi7oD2aU/css

createPlasmicElementProxy;

export const PlasmicPartnerWithAssh__VariantProps = new Array();

export const PlasmicPartnerWithAssh__ArgProps = new Array();
...
function PlasmicPartnerWithAssh__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicPartnerWithAssh.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPartnerWithAssh.pageMetadata.title}
        />
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicPartnerWithAssh.pageMetadata.description}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__mRnrn)} />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPartnerWithAssh__ArgProps,
          internalVariantPropNames: PlasmicPartnerWithAssh__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPartnerWithAssh__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPartnerWithAssh";
  } else {
    func.displayName = `PlasmicPartnerWithAssh.${nodeName}`;
  }
  return func;
}

export const PlasmicPartnerWithAssh = Object.assign(
  // Top-level PlasmicPartnerWithAssh renders the root element
  makeNodeComponent("root"),
  {
    ...
    internalArgProps: PlasmicPartnerWithAssh__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Partner with ASSH",
...
export default PlasmicPartnerWithAssh;
/* prettier-ignore-end */
