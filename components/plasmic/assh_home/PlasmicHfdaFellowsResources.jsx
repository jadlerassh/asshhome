...
import sty from "./PlasmicHfdaFellowsResources.module.css"; // plasmic-import: utHHTk9U0QIY/css

createPlasmicElementProxy;

export const PlasmicHfdaFellowsResources__VariantProps = new Array();

export const PlasmicHfdaFellowsResources__ArgProps = new Array();
...
function PlasmicHfdaFellowsResources__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicHfdaFellowsResources.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicHfdaFellowsResources.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__eNlb
            )}
          />
          ...
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: HFDA Fellows Resources - Title Card"}
          />
          ...
          >
            <HtmlContentfulHtmlLoader
              ...
              title={"HFDA Fellows Resources"}
            />
          </div>
          <SectionAdPlaceholder
            className={classNames(
              "__wab_instance",
              sty.sectionAdPlaceholder__x3G0V
            )}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHfdaFellowsResources__ArgProps,
          internalVariantPropNames: PlasmicHfdaFellowsResources__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHfdaFellowsResources__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHfdaFellowsResources";
  } else {
    func.displayName = `PlasmicHfdaFellowsResources.${nodeName}`;
  }
  return func;
}

export const PlasmicHfdaFellowsResources = Object.assign(
  // Top-level PlasmicHfdaFellowsResources renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHfdaFellowsResources
    internalVariantProps: PlasmicHfdaFellowsResources__VariantProps,
    internalArgProps: PlasmicHfdaFellowsResources__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "HFDA Fellows Resources | Education | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicHfdaFellowsResources;
/* prettier-ignore-end */
