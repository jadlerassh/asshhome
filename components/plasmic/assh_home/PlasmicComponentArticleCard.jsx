...
import sty from "./PlasmicComponentArticleCard.module.css"; // plasmic-import: m6xY8jJvNbEQ/css

createPlasmicElementProxy;

export const PlasmicComponentArticleCard__VariantProps = new Array();
...
function PlasmicComponentArticleCard__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentArticleCard__ArgProps,
          internalVariantPropNames: PlasmicComponentArticleCard__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentArticleCard__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentArticleCard";
  } else {
    func.displayName = `PlasmicComponentArticleCard.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentArticleCard = Object.assign(
  // Top-level PlasmicComponentArticleCard renders the root element
...
export default PlasmicComponentArticleCard;
/* prettier-ignore-end */
