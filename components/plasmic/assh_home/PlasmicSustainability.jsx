...
import sty from "./PlasmicSustainability.module.css"; // plasmic-import: 6TOwshJOQ5_r/css

createPlasmicElementProxy;

export const PlasmicSustainability__VariantProps = new Array();

export const PlasmicSustainability__ArgProps = new Array();
...
function PlasmicSustainability__RenderFunc(props) {
  ...
  const new$Queries = {
    getHtmlContent: usePlasmicDataOp(() => {
      return {
        ...
        opId: "ec88affe-ccb9-4585-a79e-98bc868ade59",
        userArgs: {},
        cacheKey: `plasmic.$.ec88affe-ccb9-4585-a79e-98bc868ade59.$.`,
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicSustainability.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicSustainability.pageMetadata.title}
        />
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicSustainability.pageMetadata.description}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__smNqg)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Sustainability - Title Card"}
          />

          <div className={classNames(projectcss.all, sty.freeBox__b3Sja)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__jyauV
              )}
              title={"ASSH Sustainability"}
            />
          </div>
          <div className={classNames(projectcss.all, sty.freeBox__gHzrS)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__uz5BR)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__qrkp8)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__d2Mht)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__yaEoV
                  )}
          ...
          <ItemAd
            className={classNames("__wab_instance", sty.itemAd___4QeJp)}
          />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSustainability__ArgProps,
          internalVariantPropNames: PlasmicSustainability__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSustainability__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSustainability";
  } else {
    func.displayName = `PlasmicSustainability.${nodeName}`;
  }
  return func;
}

export const PlasmicSustainability = Object.assign(
  // Top-level PlasmicSustainability renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSustainability
    internalVariantProps: PlasmicSustainability__VariantProps,
    internalArgProps: PlasmicSustainability__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Sustainability at ASSH | About | ASSH",
...
export default PlasmicSustainability;
/* prettier-ignore-end */
