...
import sty from "./PlasmicInternationalTravelingFellowsProgram.module.css"; // plasmic-import: Wk0pOjLaYGpf/css

createPlasmicElementProxy;

export const PlasmicInternationalTravelingFellowsProgram__VariantProps =
  new Array();

export const PlasmicInternationalTravelingFellowsProgram__ArgProps =
  new Array();
...
function PlasmicInternationalTravelingFellowsProgram__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicInternationalTravelingFellowsProgram.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
        ...
        <meta
          ...
          name="description"
          content={
            PlasmicInternationalTravelingFellowsProgram.pageMetadata.description
          }
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__fSgZv)} />
          ...
          <div className={classNames(projectcss.all, sty.freeBox__rnl8Q)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__qPBjp
              )}
          ...
          <div className={classNames(projectcss.all, sty.freeBox___245Xe)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__vonfr)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__joMu7)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader__w6IZe
                  )}
...
function makeNodeComponent(nodeName) {
      ...
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames:
            PlasmicInternationalTravelingFellowsProgram__ArgProps,
          internalVariantPropNames:
            PlasmicInternationalTravelingFellowsProgram__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicInternationalTravelingFellowsProgram__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicInternationalTravelingFellowsProgram";
  } else {
    func.displayName = `PlasmicInternationalTravelingFellowsProgram.${nodeName}`;
  }
  return func;
}

export const PlasmicInternationalTravelingFellowsProgram = Object.assign(
  // Top-level PlasmicInternationalTravelingFellowsProgram renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicInternationalTravelingFellowsProgram
    internalVariantProps:
      PlasmicInternationalTravelingFellowsProgram__VariantProps,
    internalArgProps: PlasmicInternationalTravelingFellowsProgram__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "International Traveling Fellows Program | Grants & Awards | ASSH",
...
export default PlasmicInternationalTravelingFellowsProgram;
/* prettier-ignore-end */
