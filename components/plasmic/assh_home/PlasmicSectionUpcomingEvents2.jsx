...
import sty from "./PlasmicSectionUpcomingEvents2.module.css"; // plasmic-import: aDAIm3T_wfOv/css

createPlasmicElementProxy;

export const PlasmicSectionUpcomingEvents2__VariantProps = new Array();

export const PlasmicSectionUpcomingEvents2__ArgProps = new Array();
...
function PlasmicSectionUpcomingEvents2__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSectionUpcomingEvents2__ArgProps,
          internalVariantPropNames: PlasmicSectionUpcomingEvents2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSectionUpcomingEvents2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSectionUpcomingEvents2";
  } else {
    func.displayName = `PlasmicSectionUpcomingEvents2.${nodeName}`;
  }
  return func;
}

export const PlasmicSectionUpcomingEvents2 = Object.assign(
  // Top-level PlasmicSectionUpcomingEvents2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSectionUpcomingEvents2
    internalVariantProps: PlasmicSectionUpcomingEvents2__VariantProps,
    internalArgProps: PlasmicSectionUpcomingEvents2__ArgProps
  }
);

export default PlasmicSectionUpcomingEvents2;
/* prettier-ignore-end */
