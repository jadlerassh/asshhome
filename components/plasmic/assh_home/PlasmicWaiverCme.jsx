...
import sty from "./PlasmicWaiverCme.module.css"; // plasmic-import: pl5eXGCKsk8J/css

createPlasmicElementProxy;

export const PlasmicWaiverCme__VariantProps = new Array();

export const PlasmicWaiverCme__ArgProps = new Array();
...
function PlasmicWaiverCme__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicWaiverCme.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicWaiverCme.pageMetadata.title}
        />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicWaiverCme__ArgProps,
          internalVariantPropNames: PlasmicWaiverCme__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicWaiverCme__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicWaiverCme";
  } else {
    func.displayName = `PlasmicWaiverCme.${nodeName}`;
  }
  return func;
}

export const PlasmicWaiverCme = Object.assign(
  // Top-level PlasmicWaiverCme renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicWaiverCme
    internalVariantProps: PlasmicWaiverCme__VariantProps,
    internalArgProps: PlasmicWaiverCme__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "CME Event Waiver | Education | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicWaiverCme;
/* prettier-ignore-end */
