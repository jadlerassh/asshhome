...
import sty from "./PlasmicComponentLinkOutCard.module.css"; // plasmic-import: ie8FiHmZHhtB/css
...
export const PlasmicComponentLinkOutCard__VariantProps = new Array();

export const PlasmicComponentLinkOutCard__ArgProps = new Array(
  "articleTitle",
  "linkUrl",
  "showIcon",
  "iconImageId"
...
function PlasmicComponentLinkOutCard__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicComponentLinkOutCard__ArgProps,
          internalVariantPropNames: PlasmicComponentLinkOutCard__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicComponentLinkOutCard__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicComponentLinkOutCard";
  } else {
    func.displayName = `PlasmicComponentLinkOutCard.${nodeName}`;
  }
  return func;
}

export const PlasmicComponentLinkOutCard = Object.assign(
  // Top-level PlasmicComponentLinkOutCard renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicComponentLinkOutCard
    internalVariantProps: PlasmicComponentLinkOutCard__VariantProps,
    internalArgProps: PlasmicComponentLinkOutCard__ArgProps
  }
);

export default PlasmicComponentLinkOutCard;
/* prettier-ignore-end */
