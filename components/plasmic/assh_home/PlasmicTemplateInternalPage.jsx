  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__aCho)} />
          ...
          <ItemSectionTitleDescriptionItem
            className={classNames(
              "__wab_instance",
              sty.itemSectionTitleDescriptionItem__s5U9B
            )}
            descriptionSection={``}
            title={``}
          />

          <div className={classNames(projectcss.all, sty.freeBox__ikA3)}>
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__fVvqW)}
          >
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__nZ5Uk)}
          >
            <ItemSectionTitleDescriptionItem
              className={classNames(
                "__wab_instance",
                sty.itemSectionTitleDescriptionItem___1Ablz
              )}
              descriptionSection={``}
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__vazFu)} />
