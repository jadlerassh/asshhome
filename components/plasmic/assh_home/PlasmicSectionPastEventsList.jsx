...
import sty from "./PlasmicSectionPastEventsList.module.css"; // plasmic-import: Eq7lpuWOmRGs/css

createPlasmicElementProxy;

export const PlasmicSectionPastEventsList__VariantProps = new Array();

export const PlasmicSectionPastEventsList__ArgProps = new Array(
  "category",
  "categoryNot",
  "num"
);
...
function PlasmicSectionPastEventsList__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSectionPastEventsList__ArgProps,
          internalVariantPropNames: PlasmicSectionPastEventsList__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSectionPastEventsList__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSectionPastEventsList";
  } else {
    func.displayName = `PlasmicSectionPastEventsList.${nodeName}`;
  }
  return func;
}

export const PlasmicSectionPastEventsList = Object.assign(
  // Top-level PlasmicSectionPastEventsList renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSectionPastEventsList
    internalVariantProps: PlasmicSectionPastEventsList__VariantProps,
    internalArgProps: PlasmicSectionPastEventsList__ArgProps
  }
);

export default PlasmicSectionPastEventsList;
/* prettier-ignore-end */
