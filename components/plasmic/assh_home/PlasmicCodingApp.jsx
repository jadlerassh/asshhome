...
import sty from "./PlasmicCodingApp.module.css"; // plasmic-import: RDuKTPY9W6Vi/css

createPlasmicElementProxy;

export const PlasmicCodingApp__VariantProps = new Array();

export const PlasmicCodingApp__ArgProps = new Array();
...
function PlasmicCodingApp__RenderFunc(props) {
  ...
  const new$Queries = {
    getHtmlContent: usePlasmicDataOp(() => {
      return {
        ...
        opId: "ad64990c-0f0f-44cc-aa96-466e8ab47c24",
        userArgs: {},
        cacheKey: `plasmic.$.ad64990c-0f0f-44cc-aa96-466e8ab47c24.$.`,
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCodingApp.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicCodingApp.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__p002N)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Coding App - Title Card"}
          />
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__yYEn)} />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCodingApp__ArgProps,
          internalVariantPropNames: PlasmicCodingApp__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCodingApp__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCodingApp";
  } else {
    func.displayName = `PlasmicCodingApp.${nodeName}`;
  }
  return func;
}

export const PlasmicCodingApp = Object.assign(
  // Top-level PlasmicCodingApp renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCodingApp
    internalVariantProps: PlasmicCodingApp__VariantProps,
    internalArgProps: PlasmicCodingApp__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Coding App | Education | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicCodingApp;
/* prettier-ignore-end */
