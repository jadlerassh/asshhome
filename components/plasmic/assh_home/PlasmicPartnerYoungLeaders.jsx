...
import sty from "./PlasmicPartnerYoungLeaders.module.css"; // plasmic-import: MmNXYcfEUXEf/css

createPlasmicElementProxy;

export const PlasmicPartnerYoungLeaders__VariantProps = new Array();

export const PlasmicPartnerYoungLeaders__ArgProps = new Array();
...
function PlasmicPartnerYoungLeaders__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicPartnerYoungLeaders.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPartnerYoungLeaders.pageMetadata.title}
        />
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <ItemAd className={classNames("__wab_instance", sty.itemAd__ePoua)} />
          <SectionInternalHeroTitleSectionV2
            ...
            title={"Hero: Young Leaders Sponsorship - Title Card"}
          />

          <div className={classNames(projectcss.all, sty.freeBox__o64L7)}>
            <HtmlContentfulHtmlLoader
              className={classNames(
                "__wab_instance",
                sty.htmlContentfulHtmlLoader__v7MkO
              )}
              title={"Partner with ASSH - Young Leaders Program"}
            />
          </div>
          <div className={classNames(projectcss.all, sty.freeBox___1OK03)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__exZin)}>
            ...
            >
              <div className={classNames(projectcss.all, sty.column__z0ZyL)}>
                <Embed
              ...
              <div className={classNames(projectcss.all, sty.column__lqwKs)}>
                <HtmlContentfulHtmlLoader
                  className={classNames(
                    "__wab_instance",
                    sty.htmlContentfulHtmlLoader___5Bn5F
                  )}
          ...
          <ItemAd className={classNames("__wab_instance", sty.itemAd__c2EW8)} />
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPartnerYoungLeaders__ArgProps,
          internalVariantPropNames: PlasmicPartnerYoungLeaders__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPartnerYoungLeaders__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPartnerYoungLeaders";
  } else {
    func.displayName = `PlasmicPartnerYoungLeaders.${nodeName}`;
  }
  return func;
}

export const PlasmicPartnerYoungLeaders = Object.assign(
  // Top-level PlasmicPartnerYoungLeaders renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPartnerYoungLeaders
    internalVariantProps: PlasmicPartnerYoungLeaders__VariantProps,
    internalArgProps: PlasmicPartnerYoungLeaders__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Young Leaders Program Sponsorship | About | ASSH",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicPartnerYoungLeaders;
/* prettier-ignore-end */
