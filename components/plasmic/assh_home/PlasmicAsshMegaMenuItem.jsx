...
import sty from "./PlasmicAsshMegaMenuItem.module.css"; // plasmic-import: PuojKIT8N0Q4/css
...
export const PlasmicAsshMegaMenuItem__VariantProps = new Array();

export const PlasmicAsshMegaMenuItem__ArgProps = new Array(
  "label",
  "url",
  "showChevron"
);
...
function PlasmicAsshMegaMenuItem__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicAsshMegaMenuItem__ArgProps,
          internalVariantPropNames: PlasmicAsshMegaMenuItem__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicAsshMegaMenuItem__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicAsshMegaMenuItem";
  } else {
    func.displayName = `PlasmicAsshMegaMenuItem.${nodeName}`;
  }
  return func;
}

export const PlasmicAsshMegaMenuItem = Object.assign(
  // Top-level PlasmicAsshMegaMenuItem renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicAsshMegaMenuItem
    internalVariantProps: PlasmicAsshMegaMenuItem__VariantProps,
    internalArgProps: PlasmicAsshMegaMenuItem__ArgProps
  }
);

export default PlasmicAsshMegaMenuItem;
/* prettier-ignore-end */
